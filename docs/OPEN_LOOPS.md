...
Last updated: 2026-09-25 +07:00 (OpenCode)
...
| L5 | เงื่อนไขก่อนเปิดฟอร์ม Contact: ~~ไม่มี `GET /api/contact`~~ ✅ · ~~validate ความยาว~~ ✅ (Lab 05) · ยังเหลือ: แจ้งเตือนเจ้าของเมื่อมีข้อความใหม่ · `DATA_DIR` บน volume ถาวร · ระยะเวลาเก็บ/วิธีลบ (DECISIONS D11) | OpenCode (backend) | P2 | Lab 08 (deploy) | ส่วน validation/error ทำแล้วใน Lab 05 ตาม `docs/fe-be-contract-check.md` + issue #8 |
